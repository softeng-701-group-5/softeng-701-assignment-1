...
function Card(props) {
  ...
  const classes = useStyles();
    ...
    return (
        <center>
        <div style = {{width: "500px", background: "#f2f2f2", padding:"10px", textAlign:"left", boxShadow:"5px 5px 5px grey", borderRadius: "8px"}}>
        ...
        {/* {switch({props.media}) {
          case "reddit":
            <p>some text</p>
            // <div style = {{width: "400px", background: "#FF4500"}, padding:"10px", textAlign:"left"}>
            //   <img src="https://redditupvoted.files.wordpress.com/2015/10/reddit_icon_twitter_fb.png" style = {{width: "40px"}}></img>
            // </div>
            break;
        ...
        {/* barcolour({props.media}) */}
        {/* <div style = {{width: "500px", background: "red", padding:"10px", textAlign:"left", boxShadow:"5px 5px 5px grey", borderRadius: "0px, 0px, 8px, 8px"}}></div> */}
        </center>
    );
}
